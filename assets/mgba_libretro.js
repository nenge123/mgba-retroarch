...
var wasmBinaryFile = "mgba_libretro.wasm";
...
var asmLibraryArg = {
    ...
    "qf": _eglBindAPI,
    "lf": _eglChooseConfig,
    "Ba": _eglCreateContext,
    "jf": _eglCreateWindowSurface,
    "Da": _eglDestroyContext,
    "pf": _eglDestroySurface,
    "mf": _eglGetConfigs,
    "nf": _eglGetCurrentContext,
    "kf": _eglGetDisplay,
    "Ha": _eglGetError,
    "Ga": _eglGetProcAddress,
    "Ea": _eglInitialize,
    "$": _eglMakeCurrent,
    "Ca": _eglQuerySurface,
    "of": _eglSwapBuffers,
    ...
    "ba": _emscripten_get_canvas_element_size,
    "Ia": _emscripten_get_fullscreen_status,
    "J": _emscripten_get_gamepad_status,
    "$d": _emscripten_glActiveTexture,
    "_d": _emscripten_glAttachShader,
    "pe": _emscripten_glBeginQueryEXT,
    "Zd": _emscripten_glBindAttribLocation,
    "Yd": _emscripten_glBindBuffer,
    ...
    "de": _emscripten_glDrawBuffersWEBGL,
    "kd": _emscripten_glDrawElements,
    "be": _emscripten_glDrawElementsInstancedANGLE,
    ...
    "se": _emscripten_glGenQueriesEXT,
    "$c": _emscripten_glGenRenderbuffers,
    "_c": _emscripten_glGenTextures,
    "fe": _emscripten_glGenVertexArraysOES,
    ...
    "Mc": _emscripten_glGetProgramInfoLog,
    "Nc": _emscripten_glGetProgramiv,
    ...
    "Lc": _emscripten_glGetRenderbufferParameteriv,
    "Jc": _emscripten_glGetShaderInfoLog,
    "Ic": _emscripten_glGetShaderPrecisionFormat,
    "Hc": _emscripten_glGetShaderSource,
    "Kc": _emscripten_glGetShaderiv,
    "Gc": _emscripten_glGetString,
    "Fc": _emscripten_glGetTexParameterfv,
    "Ec": _emscripten_glGetTexParameteriv,
    "Ac": _emscripten_glGetUniformLocation,
    "Cc": _emscripten_glGetUniformfv,
    "Bc": _emscripten_glGetUniformiv,
    "xc": _emscripten_glGetVertexAttribPointerv,
    ...
    "ae": _emscripten_glVertexAttribDivisorANGLE,
    ...
    "ue": _emscripten_resize_heap,
    "ia": _emscripten_sample_gamepad_data,
    "ka": _emscripten_set_canvas_element_size,
    "ja": _emscripten_set_element_css_size,
    "ab": _emscripten_set_gamepadconnected_callback_on_thread,
    "$a": _emscripten_set_gamepaddisconnected_callback_on_thread,
    "Pb": _emscripten_set_keydown_callback_on_thread,
    "tb": _emscripten_set_keypress_callback_on_thread,
    "Eb": _emscripten_set_keyup_callback_on_thread,
    "_b": _emscripten_set_main_loop,
    "aa": _emscripten_set_main_loop_timing,
    ...
    "ha": _glGetError,
    "T": _glGetIntegerv,
    "$e": _glGetProgramInfoLog,
    "wa": _glGetProgramiv,
    "Ue": _glGetShaderInfoLog,
    "pa": _glGetShaderiv,
    "k": _glGetString,
    ...
    "ff": _glUniform4f,
    "cf": _glUniform4fv,
    "_e": _glUniformMatrix4fv,
    "G": _glUseProgram,
    "Xe": _glVertexAttribPointer,
    "w": _glViewport,
    "e": invoke_i,
    "r": invoke_ii,
    "o": invoke_iii,
